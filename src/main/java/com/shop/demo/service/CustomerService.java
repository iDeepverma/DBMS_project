...
public class CustomerService {
    ...
    public Customer getCustomerByNumber(String phone){return customerDAO.getCustomerByNumber(phone);}

    public Customer getCustomerByEmail(String email){ return customerDAO.getCustomerByEmail(email);}

    public int updateCustomer(int id,Customer customer){return  customerDAO.updateCustomer(id, customer);}
